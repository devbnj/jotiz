				...
				case 1: // Aries
					{
						...
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Ketu";
						}
						if (($degrees >= 0.78) && ($degrees < 3.00))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Venus";
						}
						if (($degrees >= 3.00) && ($degrees < 3.67))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Sun";
						}
						if (($degrees >= 3.67) && ($degrees < 4.78))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Moon";
						}
						if (($degrees >= 4.78) && ($degrees < 5.56))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Mars";
						}
						if (($degrees >= 5.56) && ($degrees < 7.56))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Rahu";
						}
						if (($degrees >= 7.56) && ($degrees < 9.33))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Jupiter";
						}
						if (($degrees >= 9.33) && ($degrees < 11.44))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Saturn";
						}
						if (($degrees >= 11.44) && ($degrees < 13.33))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Ketu";
							$this->G_PlanetPos[$i][11] = "Mercury";
						}
						if (($degrees >= 13.33) && ($degrees < 15.56))
						{
							$this->G_PlanetPos[$i][9] = "Mars";
							$this->G_PlanetPos[$i][10] = "Venus";
							$this->G_PlanetPos[$i][11] = "Venus";
						}
